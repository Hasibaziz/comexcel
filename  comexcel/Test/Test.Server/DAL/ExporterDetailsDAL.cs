...
namespace Test.Server.DAL
{
    public partial class ExporterDetailsDAL
    {
        public DataTable GetAllExporterDetailsRecord(object param)
        {
            ...
            string sql = "SELECT [ID], [ExporterNo], [ExporterName], [RegDetails], [EPBReg] FROM [Commercial].[dbo].[ExporterDetails]";
        ...
        {
            string sql = "INSERT INTO [Commercial].[dbo].[ExporterDetails] ( ExporterNo, ExporterName, RegDetails, EPBReg ) VALUES ( @ExporterNo,  @ExporterName, @RegDetails, @EPBReg )";
            DbCommand dbCommand = db.GetSqlStringCommand(sql);
            ...
            db.AddInParameter(dbCommand, "EPBReg", DbType.String, EXEntity.EPBReg);
        ...
        {
            string sql = "UPDATE [Commercial].[dbo].[ExporterDetails] SET ExporterName= @ExporterName, RegDetails=@RegDetails, EPBReg=@EPBReg WHERE ID=@ID";
            DbCommand dbCommand = db.GetSqlStringCommand(sql);
