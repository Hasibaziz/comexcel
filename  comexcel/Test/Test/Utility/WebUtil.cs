...
namespace Test.Utility
{
    ...
    {
        public static bool sendNotificationToSiteUser(CreateUserEntity user)
        {
            ...
            if (template.Length > 0)
            {
                ...
                sb.AppendFormat("Thank you for registering in {0}<br />. Your user name and passwords are -.<br /><br />", ConfigReader.SiteName);
                sb.AppendFormat("User Name: {0}<br />Password: {1}<br /> ", user.UserName, user.Password, user.LocID);
